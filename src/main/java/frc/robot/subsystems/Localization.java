...
public class Localization extends SubsystemBase {
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("chicken robot error theta", poseToGoTo.getRotation().getDegrees() -  computeThetaError(swerveDrivetrain.getPose().getRotation().getDegrees(), false));
    debugPID();
  ...
  public void debugPID(){
    ...
    // SmartDashboard
    Pose2d poseToGoTo = getClosestScoringLoc();
    //Rotation2d realTheta = swerveDrivetrain.getPose().getRotation();
