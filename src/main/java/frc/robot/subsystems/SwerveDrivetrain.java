...
public class SwerveDrivetrain extends SubsystemBase {
  ...
  public void periodic() {
    ...
    logger.recordOutput("Odometry Robot Location", getPose());
    logger.recordOutput("Odometry Robot Pose X", getPose().getX());
    logger.recordOutput("Odometry Robot Pose Y", getPose().getY());
    logger.recordOutput("Odometry Robot Location W deg", getPose().getRotation().getDegrees());
