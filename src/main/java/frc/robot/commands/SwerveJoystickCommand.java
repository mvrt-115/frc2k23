...
public class SwerveJoystickCommand extends CommandBase {
  ...
  public void execute() {
    ...
    if (left_trigger > 0.05) {
      ...
      Constants.SwerveDrivetrain.kDriveMaxSpeedMPS = (1 + 2.50 * right_trigger) * Constants.SwerveDrivetrain.kDriveMaxSpeedMPSNormal;
      Constants.SwerveDrivetrain.kTurnMaxSpeedRPS = (1 + 2.50 * right_trigger) * Constants.SwerveDrivetrain.kTurnMaxSpeedRPSNormal;
