...
import frc.robot.subsystems.DriveSimulationData;
 ...
 */
public class BetterSwerveControllerCommand extends CommandBase {
   ...
   */
  public BetterSwerveControllerCommand(
  ...
  public void execute() {
    ...
    SmartDashboard.putNumber("Desired Auton Heading Rad", m_trajectory.sample(curTime).poseMeters.getRotation().getRadians());

    var targetChassisSpeeds =
        m_controller.calculate(m_pose.get(), desiredState, m_trajectory.sample(curTime).poseMeters.getRotation());
